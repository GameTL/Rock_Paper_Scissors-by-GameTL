...
def enter_or_update_username():
    ...
    name_under_10 = 'True'
    while str(name_under_10) == 'True':
        player_name = input()
        if len(player_name) <= 10:
            name_under_10 = 'False'
        if len(player_name) > 10:
            print('Name under 10 characters please')
...
while keep_playing is True:
    ...
    if player_status == 'lose':
        ...
        divider()
        combo_power = 1
        player_score = player_score - (100 * (2)**losing_power)
        losing_power = losing_power + 1
    display_score()
    divider()
...
initalise_csv_file()
write_single_player_line_score_csv()
read_single_player_line_score_csv()
divider()
leaderboard_print()
